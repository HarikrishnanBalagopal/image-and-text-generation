"""
Progressively Growing GAN. Taken from:
https://github.com/facebookresearch/pytorch_GAN_zoo/blob/master/models/progressive_gan.py
# Copyright (c) Facebook, Inc. and its affiliates. All Rights Reserved
"""

import torch.optim as optim

from imgtxtgen.arch3.models.base_gan import BaseGAN
from imgtxtgen.arch3.utils.config import BaseConfig
from imgtxtgen.arch3.models.progressive_conv_net import GNet, DNet
...
class ProgressiveGAN(BaseGAN):
    ...
    def __init__(self, dimLatentVector=512, depthScale0=512, initBiasToZero=True, leakyness=0.2, perChannelNormalization=True, miniBatchStdDev=False, equalizedlR=True, **kwargs):
        r"""
        Args:
        ...
        Specific Arguments:
            ...
            - equalizedlR (bool): if True, forces the optimizer to see weights in range (-1, 1)
        """
        ...
        super().__init__(dimLatentVector, **kwargs)
    ...
    def updateAlpha(self, newAlpha):
        ...
        Args:
            - alpha (float): blending factor (in [0,1]). 0 means only the highest resolution in considered (no blend), 1 means the highest resolution is fully discarded.
        """
